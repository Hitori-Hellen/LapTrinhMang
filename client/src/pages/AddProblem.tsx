...
export default function AddProblem() {
    ...
    const handleAdd = async () => {
        ...
        if (sample && notSample)
            ...
            toast.error(
                "You have to add at least one custom and sample testcase"
            )
    }
        ...
        <>
            <div className="max-w-4xl mx-auto font-mono my-4">
                <h1 className="text-4xl">
                    {problem &&
                    editDetails.edit === "true" &&
                    editDetails.problemId
                        ? "Edit"
                        : "Create"}{" "}
                    Problem
                </h1>
                ...
                editDetails.problemId ? (
                    ...
                    <p className="text-sm italic text-gray-500 my-2">
                        Get started by providing the initial details needed to
                        create a problem.
                    </p>
                )}
